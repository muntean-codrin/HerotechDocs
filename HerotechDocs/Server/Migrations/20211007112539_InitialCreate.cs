...
namespace HerotechDocs.Server.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatabaseFileId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contracts_DatabaseFiles_DatabaseFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Expenses_DatabaseFiles_DatabaseFileId",
                        column: x => x.DatabaseFileId,
                        principalTable: "DatabaseFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Items_DatabaseFiles_DatabaseFileId",
                        column: x => x.DatabaseFileId,
                        principalTable: "DatabaseFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contracts_DatabaseFileId",
                table: "Contracts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_DatabaseFileId",
                table: "Expenses",
                column: "DatabaseFileId");
